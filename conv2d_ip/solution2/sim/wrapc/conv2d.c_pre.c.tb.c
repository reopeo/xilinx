...
// ==============================================================
# 1 "/home/reon/work/xilinx/conv2d_ip/src/conv2d.c"
# 1 "/home/reon/work/xilinx/conv2d_ip/src/conv2d.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 149 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/reon/work/xilinx/conv2d_ip/src/conv2d.c" 2
...
# 2 "/home/reon/work/xilinx/conv2d_ip/src/conv2d.c" 2
# 20 "/home/reon/work/xilinx/conv2d_ip/src/conv2d.c"
...
extern "C"
#endif
void apatb_conv2d_ir(const float *, const float *, const float *, int, int, int, int, int, float *);
#ifdef __cplusplus
extern "C"
#endif
void conv2d_hw_stub(const float *x, const float *weight, const float *bias, int width, int height, int in_channels, int out_channels, int ksize, float *y){
...
extern "C"
#endif
void apatb_conv2d_sw(const float *x, const float *weight, const float *bias, int width, int height, int in_channels, int out_channels, int ksize, float *y){
apatb_conv2d_ir(x, weight, bias, width, height, in_channels, out_channels, ksize, y);
return ;
}
#endif
# 61 "/home/reon/work/xilinx/conv2d_ip/src/conv2d.c"
