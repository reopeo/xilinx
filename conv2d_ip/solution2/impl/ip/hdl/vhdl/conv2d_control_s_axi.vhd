...
architecture behave of conv2d_control_s_axi is
    ...
    constant ADDR_WEIGHT_DATA_0       : INTEGER := 16#18#;
    constant ADDR_WEIGHT_CTRL         : INTEGER := 16#1c#;
    constant ADDR_BIAS_DATA_0         : INTEGER := 16#20#;
    constant ADDR_BIAS_CTRL           : INTEGER := 16#24#;
    ...
    constant ADDR_IN_CHANNELS_DATA_0  : INTEGER := 16#38#;
    constant ADDR_IN_CHANNELS_CTRL    : INTEGER := 16#3c#;
    constant ADDR_OUT_CHANNELS_DATA_0 : INTEGER := 16#40#;
    constant ADDR_OUT_CHANNELS_CTRL   : INTEGER := 16#44#;
    constant ADDR_KSIZE_DATA_0        : INTEGER := 16#48#;
    constant ADDR_KSIZE_CTRL          : INTEGER := 16#4c#;
    constant ADDR_Y_DATA_0            : INTEGER := 16#50#;
    constant ADDR_Y_CTRL              : INTEGER := 16#54#;
    ...
    signal int_ksize           : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_KSIZE_DATA_0 =>
                        rdata_data <= RESIZE(int_ksize(31 downto 0), 32);
                    when ADDR_Y_DATA_0 =>
...
-- ----------------------- Register logic ----------------
    ...
    ksize                <= STD_LOGIC_VECTOR(int_ksize);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_KSIZE_DATA_0) then
                    int_ksize(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_ksize(31 downto 0));
                end if;
            end if;
        end if;
    end process;
