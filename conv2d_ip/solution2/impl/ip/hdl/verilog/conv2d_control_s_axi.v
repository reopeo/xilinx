...
localparam
    ...
    ADDR_X_DATA_0            = 7'h10,
    ADDR_X_CTRL              = 7'h14,
    ADDR_WEIGHT_DATA_0       = 7'h18,
    ADDR_WEIGHT_CTRL         = 7'h1c,
    ...
    ADDR_IN_CHANNELS_DATA_0  = 7'h38,
    ADDR_IN_CHANNELS_CTRL    = 7'h3c,
    ADDR_OUT_CHANNELS_DATA_0 = 7'h40,
    ADDR_OUT_CHANNELS_CTRL   = 7'h44,
    ADDR_KSIZE_DATA_0        = 7'h48,
    ADDR_KSIZE_CTRL          = 7'h4c,
    ADDR_Y_DATA_0            = 7'h50,
    ADDR_Y_CTRL              = 7'h54,
    WRIDLE                   = 2'd0,
    WRDATA                   = 2'd1,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_KSIZE_DATA_0: begin
                    rdata <= int_ksize[31:0];
                end
                ADDR_Y_DATA_0: begin
                    rdata <= int_y[31:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_KSIZE_DATA_0)
            int_ksize[31:0] <= (WDATA[31:0] & wmask) | (int_ksize[31:0] & ~wmask);
    end
end
