; ModuleID = '/home/reon/work/xilinx/conv2d_ip/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline
define void @apatb_conv2d_ir(float* noalias nocapture nonnull readonly %x, float* noalias nocapture nonnull readonly %weight, float* noalias nocapture nonnull readonly %bias, i32 %width, i32 %height, i32 %in_channels, i32 %out_channels, i32 %ksize, float* noalias nocapture nonnull %y) local_unnamed_addr #0 {
entry:
  %x_copy = alloca float, align 512
  %weight_copy = alloca float, align 512
  %bias_copy = alloca float, align 512
  %y_copy = alloca float, align 512
  call fastcc void @copy_in(float* nonnull %x, float* nonnull align 512 %x_copy, float* nonnull %weight, float* nonnull align 512 %weight_copy, float* nonnull %bias, float* nonnull align 512 %bias_copy, float* nonnull %y, float* nonnull align 512 %y_copy)
  call void @apatb_conv2d_hw(float* %x_copy, float* %weight_copy, float* %bias_copy, i32 %width, i32 %height, i32 %in_channels, i32 %out_channels, i32 %ksize, float* %y_copy)
  call void @copy_back(float* %x, float* %x_copy, float* %weight, float* %weight_copy, float* %bias, float* %bias_copy, float* %y, float* %y_copy)
  ret void
}
...
declare void @apatb_conv2d_hw(float*, float*, float*, i32, i32, i32, i32, i32, float*)
...
define void @conv2d_hw_stub_wrapper(float*, float*, float*, i32, i32, i32, i32, i32, float*) #4 {
entry:
  call void @copy_out(float* null, float* %0, float* null, float* %1, float* null, float* %2, float* null, float* %8)
  call void @conv2d_hw_stub(float* %0, float* %1, float* %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, float* %8)
  call void @copy_in(float* null, float* %0, float* null, float* %1, float* null, float* %2, float* null, float* %8)
  ret void
}

declare void @conv2d_hw_stub(float*, float*, float*, i32, i32, i32, i32, i32, float*)
