...
using hls::sim::Byte;
extern "C" void cnn_top(Byte<4>*, Byte<4>*);
extern "C" void apatb_cnn_top_hw(volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_y) {
...
__xlx_y__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_y)[i]);
  ...
  // DUT call
  cnn_top(__xlx_x__tmp_vec.data(), __xlx_y__tmp_vec.data());
