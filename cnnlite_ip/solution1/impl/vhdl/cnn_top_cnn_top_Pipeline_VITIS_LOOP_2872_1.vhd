...
entity cnn_top_cnn_top_Pipeline_VITIS_LOOP_2872_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cnn_top_cnn_top_Pipeline_VITIS_LOOP_2872_1 is 
...
attribute shreg_extract : string;
    ...
    signal i_5_fu_91_p2 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    bitcast_ln2874_fu_107_p1 <= vla1_i_load_reg_176_pp0_iter2_reg;
    grp_fu_853_p_ce <= ap_const_logic_1;
    grp_fu_853_p_din0 <= vla1_i_load_reg_176;
    grp_fu_853_p_din1 <= ap_const_lv32_0;
    grp_fu_853_p_opcode <= ap_const_lv5_2;
    i_5_fu_91_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_4) + unsigned(ap_const_lv12_1));
    i_cast_fu_97_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_4),64));
    icmp_ln2872_fu_85_p2 <= "1" when (ap_sig_allocacmp_i_4 = ap_const_lv12_C40) else "0";
    icmp_ln2874_1_fu_130_p2 <= "1" when (trunc_ln2874_fu_120_p1 = ap_const_lv23_0) else "0";
    icmp_ln2874_fu_124_p2 <= "0" when (tmp_fu_110_p4 = ap_const_lv8_FF) else "1";
    or_ln2874_fu_136_p2 <= (icmp_ln2874_fu_124_p2 or icmp_ln2874_1_fu_130_p2);
    select_ln2874_fu_148_p3 <= 
        vla1_i_load_reg_176_pp0_iter2_reg when (and_ln2874_fu_142_p2(0) = '1') else 
        ap_const_lv32_0;
    tmp_fu_110_p4 <= bitcast_ln2874_fu_107_p1(30 downto 23);
    ...
    vla42_i_d0 <= select_ln2874_reg_183;
