...
extern "C"
void cnn_top_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_cnn_top_hw(void* __xlx_apatb_param_x, void* __xlx_apatb_param_y)
{
#ifdef USE_BINARY_TV_FILE
  ...
  try {
    ...
    cnn_top_hw_stub_wrapper(__xlx_apatb_param_x, __xlx_apatb_param_y);
