...
architecture behave of cnn_top_control_s_axi is
    ...
    constant ADDR_Y_BASE  : INTEGER := 16#0040#;
    constant ADDR_Y_HIGH  : INTEGER := 16#007f#;
    constant ADDR_X_BASE  : INTEGER := 16#1000#;
    constant ADDR_X_HIGH  : INTEGER := 16#1fff#;
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_y_read = '0') and (int_x_read = '0') else '0';
    RVALID    <= RVALID_t;
