...
extern "C"
hls::sim::Byte<4> muladd_hw_stub_wrapper(void*, void*);

extern "C"
hls::sim::Byte<4> apatb_muladd_hw(void* __xlx_apatb_param_a, void* __xlx_apatb_param_b)
{
  ...
  try {
    ...
    ap_return = muladd_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_b);
