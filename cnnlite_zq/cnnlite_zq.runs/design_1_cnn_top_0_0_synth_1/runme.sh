...
HD_PWD='/home/reon/work/xilinx/cnnlite_zq/cnnlite_zq.runs/design_1_cnn_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cnn_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cnn_top_0_0.tcl
