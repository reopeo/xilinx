...
extern "C"
#endif
void apatb_cnn_ir(const float *, const float *, const float *, const float *, const float *, const float *, const float *, const float *, const float *, float *);
#ifdef __cplusplus
extern "C"
#endif
void cnn_hw_stub(const float *x, const float *weight0, const float *bias0, const float *weight1, const float *bias1, const float *weight2, const float *bias2, const float *weight3, const float *bias3, float *y){
...
extern "C"
#endif
void apatb_cnn_sw(const float *x, const float *weight0, const float *bias0, const float *weight1, const float *bias1, const float *weight2, const float *bias2, const float *weight3, const float *bias3, float *y){
apatb_cnn_ir(x, weight0, bias0, weight1, bias1, weight2, bias2, weight3, bias3, y);
return ;
}
#endif
# 46 "/home/reon/work/xilinx/cnn_ip/src/cnn.c"
